...
process.source = cms.Source(
    "PoolSource",
    #fileNames = cms.untracked.vstring(["file:/data/user/vkhriste/data/test_hcal_numEvent100.root"])
    fileNames = cms.untracked.vstring(["file:/opt/cms/09D95BE7-23C8-5542-9FA4-102E3FEDB7A2.root"])
)
